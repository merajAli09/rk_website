  ...
  return (
    <PageShell>
      ...
      <main>
        ...
        <section className="branch-cta-section" data-testid="branch-cta-section"><div className="page-container branch-cta-inner"><div><p className="eyebrow">Your next session starts here</p><h2>Ready to train<br /><span>at {branch.name}?</span></h2></div><div className="branch-cta-actions"><a href={`tel:${branch.phone}`} className="yellow-button inline-button" data-testid="branch-call-now-button"><Phone /> Call now</a><a href={branch.directionsUrl} target="_blank" rel="noreferrer" className="outline-button" data-testid="branch-cta-directions-button">Get directions <ArrowUpRight /></a></div></div></section>
      </main>
      <Footer />
